...
class WalletsView extends StatefulWidget {
  ...
  const WalletsView({super.key, required this.cardName, required this.imagePath});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.cardName,
          style: GoogleFonts.montserrat(textStyle: const TextStyle(color: Color.fromARGB(134, 0, 0, 0), fontSize: 18, fontWeight: FontWeight.w600)),
        ),
      ),
